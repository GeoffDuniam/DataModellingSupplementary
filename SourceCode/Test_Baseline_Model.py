...
def train_model(i, samples_train, samples_valid):
    ...
    logger.info("--- Augmented training samples - %s  ---" % len(samples_train))
...
if __name__ == '__main__':
    ...
    logger.info("Beginning baseline model test at {}".format(str(start_elapsed)) )
    ...
    for i in range(1, num_models+1):
        ...
        logger.info(len(samples_train))
        logger.info(len(samples_valid))
        ...
        buildModelElapsed, buildModelElapseCpu,\
        trainModelElapsed, trainModelElapseCpu,\
        predictModelElapsed,predictModelElapseCpu=train_model(i, samples_train, samples_valid)
